...
THREE.DeviceOrientationControls = function(object) {
  ...
  var dirQ = new THREE.Quaternion();

  var zee = new THREE.Vector3(1, 0, 0);
  ...
  this.updateDir = function(dir){
      var tmp = dir.clone(); tmp.normalize();
      // zee.set(tmp.x, tmp.z, tmp.y);
  }
  ...
  this.update = (function(delta) {
    ...
    return function(delta) {
      ...
      this.object.quaternion.multiply(dirQ);
